...
const SideBar = (props)=>{
  const [check, setCheck] = useState({profile:true,  booking:false, rentCar:false, delete:false});
        ...
        <>
         ...
         <input onChange={sideBarToggle} checked={check.profile} value='profile' type="radio" className="btn-check sideBar" name="btnradio" id="btnradio1" autoComplete="off"/>
          <label className="btn btn-outline-warning" style={{width: '20vw', height:'4vw', fontSize: '2vw',padding: '1vw', textAlign: 'center' }} htmlFor="btnradio1">Profile</label>
            ...
            <input onChange={sideBarToggle} checked={check.bookings} value='bookings' type="radio" className="btn-check sideBar" name="btnradio" id="btnradio2" autoComplete="off"/>
          ...
          <input onChange={sideBarToggle} checked={check.book} value='rentCar' type="radio" className="btn-check sideBar" name="btnradio" id="btnradio5" autoComplete="off"/>
